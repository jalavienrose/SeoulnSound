...
from main.views import register, login_user, logout_user, show_main, create_shop_entry, show_xml, show_json, show_xml_by_id, show_json_by_id, edit_shop, delete_shop, add_shop_entry_ajax
